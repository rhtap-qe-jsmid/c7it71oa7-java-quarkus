...
export IMAGE_URL=${IMAGE_URL-quay.io/jsmid/rhtap-qe-java-quarkus:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/c7it71oa7-java-quarkus-gitops
